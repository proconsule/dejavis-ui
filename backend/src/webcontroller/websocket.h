...
#include "backend/src/db/shadertoydb.h"
...
enum class DEJAVISUI_MSGID {
        ...
        // Preset & Library Management ProjectM
        PROJECTM_PRESET_LOAD_FILE = 4011,
        PROJECTM_PRESET_MOVE_CATEGORY = 4016,
        PROJECTM_CATEGORY_DELETE = 4017,
        PROJECTM_CATEGORY_ADD = 4018,
        PROJECTM_CATEGORY_LIST_REQ = 4019,
        PROJECTM_PRESET_LIST_REQ = 4020,
        PROJECTM_PRESET_ADD_DATA = 4021,
        PROJECTM_PRESET_SET_STAR = 4023,
        PROJECTM_PRESET_SET_FAVORITE = 4024,
        PROJECTM_PRESET_REMOVE = 4025,
        PROJECTM_PRESET_LOAD_DATA = 4026,
		PROJECTM_PRESET_RANDOM = 4027,
		PROJECTM_PRESET_PREV = 4028,
		PROJECTM_PRESET_NEXT = 4029,
		PROJECTM_GETPRESET_STRING = 4030,
		...
		// VIDEO BUS
		ASSIGN_VIDEO_BUS = 10001,
		SET_WEBRTC_PREVIEW_BUS = 10002,
		SET_SPOUT_PREVIEW_BUS = 10003,
		SET_DISPLAY_BUS = 10004,
		SET_NDI_BUS = 10005,


		// SHADERTOY

		LOAD_SHADERTOY_LAYER = 20000,
		CLEAN_SHADERTOY_LAYER = 20001,
		SHADERTOY_TEST_SHADER = 20002,
		SHADERTOY_DEPLOY_SHADER = 20003,
		SHADERTOY_ASSIGN_ICHANNEL = 20004,
		SHADERTOY_GETCURRENT = 20005,

		SHADERTOY_PRESET_MOVE_CATEGORY = 20016,
		SHADERTOY_CATEGORY_DELETE = 20017,
		SHADERTOY_CATEGORY_ADD = 20018,
		SHADERTOY_CATEGORY_LIST_REQ = 20019,
		SHADERTOY_PRESET_LIST_REQ = 20020,
		SHADERTOY_PRESET_ADD_DATA = 20021,
		SHADERTOY_PRESET_SET_STAR = 20023,
		PSHADERTOY_PRESET_SET_FAVORITE = 20024,
		SHADERTOY_PRESET_REMOVE = 20025,
		SHADERTOY_PRESET_LOAD_DATA = 20026,
		SHADERTOY_PRESET_RANDOM = 20027,
		SHADERTOY_PRESET_PREV = 20028,
		SHADERTOY_PRESET_NEXT = 20029,
...
class CWebSocket : public drogon::WebSocketController<CWebSocket>
{
  public:
	...
	static cshadertoydb *mShaderToyDB;
